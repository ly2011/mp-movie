<template>
  <div class="md-movie-item">
    <view class="md-movie-item__item">
      <image class="md-movie-item__poster" :src="movie.images.small" />
      <view class="md-movie-item__meta">
        ...
        <view class="md-movie-item__artists">导演：<block v-for="director in movie.directors" :key="director.id"> {{ director.name }}</block></view>
      </view>
